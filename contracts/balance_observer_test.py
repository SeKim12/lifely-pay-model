...
#
# from contracts import pool_factory, balance_tracker
...
#
#         self.balancer = balance_observer.BalanceTracker(self.va_pool, self.sa_pool, self.fee_pool)
...
#         self.assertEqual(len(self.balancer._total_assets_list_usd()), 3)
